...
#Removes the character at index 0 which is the first character.
code.slice!(0)

#insert takes two arguments, the first one is the index and the second would be the characters to be inserted.
code.insert(11, "A EW? O")

#delete! modifies the string by removing all instances of the argument provided.
code.delete!("Q?,")

#downcase! does step 3 by turning the entire string into lowercase.
#reverse! reverses the string.
#capitalize! turns the first character of the string into an uppercase character.
code.downcase!.reverse!.capitalize!

#prints out the code in the terminal
puts code
